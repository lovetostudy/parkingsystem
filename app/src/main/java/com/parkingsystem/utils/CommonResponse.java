...
/**
 * 常规返回报文格式化(如果有数组只能是单层数组,业务逻辑复杂时请服务端优化逻辑,
 * 或者分开请求不同的接口)
 */
public class CommonResponse {
     ...
     * 通用报文返回构造函数
     *
     * @param responseString Json格式返回字符串
     */
    public CommonResponse(String responseString) {

        // 日志输出原始应答报文
        LogUtil.logRespnse(responseString);
     ...
     * @param targetMap
     */
    private void parseProperty(JSONObject property,
