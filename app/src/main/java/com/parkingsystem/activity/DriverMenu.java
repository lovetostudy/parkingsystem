...
import com.parkingsystem.utils.overlayutil.BikingRouteOverlay;
import com.parkingsystem.utils.overlayutil.DrivingRouteOverlay;
import com.parkingsystem.utils.overlayutil.OverlayManager;
import com.parkingsystem.utils.overlayutil.TransitRouteOverlay;
import com.parkingsystem.utils.overlayutil.WalkingRouteOverlay;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class DriverMenu extends BaseActivity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*equestLocButton = (Button) findViewById(R.id.driver_change);*/
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withLocation(new LatLng(114.934608,25.860302));
        PlanNode enNode = PlanNode.withLocation(new LatLng(114.934608,25.860302));
